...
### What I build
- **ASP.NET Core 8** REST APIs with Clean Architecture, JWT auth, and role-based access control
- **React 18/19** SPAs with TypeScript, Tailwind CSS, and real-time SignalR
- **Cloud deployments** — Azure App Service, Render, Vercel — with GitHub Actions CI/CD
